...
public class Parameters : HealthServicePage
{
         ...
         public string getHaemoglobin(HealthRecordInfo abc)
    {
         ...
         public void   getParambyfiltering(Guid pid,decimal caseid)
         {
...
public class ParameterValues : HealthServicePage
{
    ...
    public string get_Parameter(int id, Guid pid)
    {
        HealthRecordInfo hrf = PersonInfo.AuthorizedRecords[pid];
        String parameter = "";
        switch (id)
        {

            case 1:
                parameter = getTemperature(hrf);
                return parameter;
            case 2:
                parameter = getWeight(hrf);
                return parameter;
            case 3:
                parameter = getBloodPressure_Systolic(hrf);
                return parameter;
            case 4:
                parameter = getBloodPressure_Diastolic(hrf);
                return parameter;
            case 5:
                parameter = getBloodGlucose_BeforeEating(hrf);
                return parameter;
            case 6:
                parameter = getBloodGlucose_AfterEating(hrf);
                return parameter;
            case 7:
                parameter = getHaemoglobin(hrf);
                return parameter;
            case 8:
                parameter = getHighDensityLipid(hrf);
                return parameter;
            case 9:
                parameter = getLowDensityLipid(hrf);
                return parameter;
            case 10:
                parameter = getTriglyceride(hrf);
                return parameter;
            case 11:
                parameter = getAllergy(hrf);
                return parameter;
